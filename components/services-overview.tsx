...
export function ServicesOverview() {
  return (
    <section className="py-20 bg-gradient-to-b from-white via-soft-blush/20 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-midnight mb-6">
            Comprehensive
                ...
                <ul className="space-y-2 mb-6">
                  {service.features.map((feature, featureIndex) => (
                    <li key={featureIndex} className="flex items-center space-x-3">
                      ...
                      <span className="text-sm text-midnight">{feature}</span>
                    </li>
                  ))}
                </ul>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-royal-plum to-sunset-coral rounded-2xl p-8 md:p-12 text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact" className="bg-white text-royal-plum font-semibold py-3 px-8 rounded-full hover:bg-gray-100 transition-colors duration-300">
                Schedule Consultation
              </Link>
              <Link href="/services" className="border-2 border-white text-white font-semibold py-3 px-8 rounded-full hover:bg-white hover:text-royal-plum transition-all duration-300">
                View All Services
              </Link>
            </div>
          </div>
